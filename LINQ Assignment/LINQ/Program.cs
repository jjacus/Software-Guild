...
namespace LINQ
{
    class Program
    {
        ...
        static void Exercise5(List<Product> products)
        {
            ...
            //PrintProductInformation(priceJump);
        }
        ...
        static void Exercise28(List<Product> products)
        {
            var byCategory = from product in products
                             ...
                             select new
                             {
                                 ...
                                 TotalCount = productGroup.Count()
                             };
            foreach (var product in byCategory)
            {
                Console.WriteLine("{0}", product.Group);
                Console.WriteLine("\t{0}", product.TotalCount);
            }
        }
        ...
        static void Exercise29(List<Product> products)
        {
            var byCategory = from product in products
                             ...
                             {
                                 Group = productGroup.Key,
                                 Units = productGroup.Sum(x => x.UnitPrice)
                             };
            foreach (var product in byCategory)
            {
                Console.WriteLine("{0}", product.Group);
                Console.WriteLine("\t{0}", product.Units);
            }
        }
        ...
        static void Exercise30(List<Product> products)
        {
            var byCategory = from product in products
                             ...
                             {
                                 Group = productGroup.Key,
                                 LowestPrice = productGroup.Min(x => x.ProductName)
                             };
            foreach (var product in byCategory)
            {
                Console.WriteLine("{0}", product.Group);
                Console.WriteLine("\t{0}", product.LowestPrice);              
            }
        }
